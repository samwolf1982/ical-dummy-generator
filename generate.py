...
PRODID:-//ZY//The simple test data generator for ICal//EN
VERSION:2.0
METHOD:PUBLISH
"""

#ics_file = open(file_location, "w+")
...
CLASS:PRIVATE
DESCRIPTION: """+str(counter)+""": Test event """+event_end.strftime('%m-%d %H:%M ')+"""
SUMMARY: """+str(counter)+""": Test event """+event_end.strftime('%m-%d %H:%M ')+"""
DTSTAMP:{}
DTSTART:{}
DTEND:{}
PRIORITY:9
